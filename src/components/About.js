...
export default function About(props) {
    let darkModeTLDetails = {
        backgroundColor: props.mode !== 'light' && '#365269'
    }
    let darkModeListGroup = {
        backgroundColor: props.mode !== 'light' && '#687d8e',
            ...
            <div className='container'>
                <div className="row mt-5">
                    <div className="col-lg-6">
                        <div className={`card ${props.mode !== 'light' ? 'text-light' : 'text-dark'}
                    ${props.mode !== 'light' ? '' : 'bg-light'} mb-3`} style={darkModeTLDetails}>
                            ...
                            <div className="card-body">
                                ...
                                <ul className="list-group">
                                    <li className="list-group-item" style={darkModeListGroup}>HTML</li>
                                    <li className="list-group-item" style={darkModeListGroup}> CSS</li>
                                    <li className="list-group-item" style={darkModeListGroup}>JAVASCRIPT</li>
                                    <li className="list-group-item" style={darkModeListGroup}>REACT JS</li>
                                    <li className="list-group-item" style={darkModeListGroup}>VSCODE</li>
                                    <li className="list-group-item" style={darkModeListGroup}>GOOGLE CHROME</li>
                                </ul>
                                <p className="card-text my-3">
                                    For More Details Contact: <a className={props.mode !== 'light' && 'text-warning'} href="https://www.facebook.com/shihabunjisan">Fb: Shihabun Mobin Jisan</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-6">
                        <div className="card" style={darkModeProfile}>
                            ...
                            <div className={`card-body ${props.mode !== 'light' && 'text-light'}`}>
